...
impl MockMessageText {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageText::new()
    ///     .text("/start")
    ///     .build();
    ...
    /// assert_eq!(message.text().unwrap(), dataset::MockMessageText::TEXT.to_string());  // TEXT is a default value
    /// ```
    ///
...
impl MockMessageAnimation {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageAnimation::new()
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageAnimation::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.has_media_spoiler(), dataset::MockMessageAnimation::HAS_MEDIA_SPOILER);  // HAS_MEDIA_SPOILER is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageAudio {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageAudio::new()
    ///     .duration(236)
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageAudio::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.audio().unwrap().duration, dataset::MockMessageAudio::DURATION);  // DURATION is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageContact {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageContact::new()
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageContact::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.contact().unwrap().phone_number, dataset::MockMessageContact::PHONE_NUMBER);  // PHONE_NUMBER is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageDocument {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageDocument::new()
    ///     .file_id("12345")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageDocument::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.document().unwrap().file.id, dataset::MockMessageDocument::FILE_ID);  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageGame {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageGame::new()
    ///     .title("title")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageGame::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.game().unwrap().title, dataset::MockMessageGame::TITLE);  // TITLE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVenue {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageVenue::new()
    ///     .title("title")
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageVenue::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.venue().unwrap().title, dataset::MockMessageVenue::TITLE);  // TITLE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageLocation {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageLocation::new()
    ///     .latitude(50.0)
    ///     .build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageLocation::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.location().unwrap().latitude, dataset::MockMessageLocation::LATITUDE);  // LATITUDE is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessagePhoto {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessagePhoto::new()
    ///     .has_media_spoiler(true)
    ///     .photo(vec![dataset::MockPhotoSize::new().build(); 3])
    ///     .build();
    /// assert_eq!(message.has_media_spoiler(), true);
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessagePhoto::new();
    /// let message = mock_message.build();
...
impl MockMessagePoll {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessagePoll::new()
    ///     .poll_id("123456")
    ///     .build();
    ///
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessagePoll::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.poll().unwrap().id, dataset::MockMessagePoll::POLL_ID);  // POLL_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageSticker {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageSticker::new().file_id("12345").build();
    ///
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageSticker::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.sticker().unwrap().file.id, dataset::MockMessageSticker::FILE_ID);  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVideo {
    ...
    /// ```
    /// let message =
    /// dataset::MockMessageVideo::new().video(dataset::MockVideo::new().file_id("12345").build()).build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageVideo::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.video().unwrap().file.id, dataset::MockVideo::FILE_ID);  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVideoNote {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageVideoNote::new().length(50).build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageVideoNote::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.video_note().unwrap().file.id, dataset::MockMessageVideoNote::FILE_ID);  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
...
impl MockMessageVoice {
    ...
    /// # Example
    /// ```
    /// let message = dataset::MockMessageVoice::new().duration(1).build();
    ...
    /// # Example
    /// ```
    /// let mock_message = dataset::MockMessageVoice::new();
    /// let message = mock_message.build();
    /// assert_eq!(message.voice().unwrap().file.id, dataset::MockMessageVoice::FILE_ID);  // FILE_ID is a default value
    /// ```
    ///
    pub fn build(self) -> Message {
        self.clone()
